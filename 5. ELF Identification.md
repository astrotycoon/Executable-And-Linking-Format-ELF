...
Class **ELFCLASS32** supports machines with files and virtual address spaces up to 4 gigabytes.  It uses the basic types defined in the table labeled [``32-Bit Data Types."](https://github.com/astrotycoon/Executable-And-Linking-Format-ELF-/blob/main/3.%20Data%20Representation.md)

**ELFCLASS32**表明是32-bit平台。

Class **ELFCLASS64** is reserved for 64-bit architectures such as 64-bit SPARC and x64. It uses the basic types defined in the table labeled [``64-Bit Data Types."](https://github.com/astrotycoon/Executable-And-Linking-Format-ELF-/blob/main/3.%20Data%20Representation.md)
