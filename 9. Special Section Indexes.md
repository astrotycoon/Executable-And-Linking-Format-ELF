...
***ElfXX_Sym***中的`st_shndx`以及***ElfXX_Ehdr***中的`e_shnum`和`e_shstrndx`会用到这些**预留值**，总结下来使用这些预留值有两种用途：。具体请参阅[``Extended Section Header"](https://github.com/astrotycoon/Executable-And-Linking-Format-ELF/blob/main/15.%20Extended%20Section%20Header.md)。
